...
class WebApp:
    ...
    def __init__(self):
        ...
        chrome.driver.find_element(By.XPATH, '//*[@id="RESULT_TextField-1"]').send_keys("praveen")
        chrome.driver.find_element(By.XPATH,'//*[@id="RESULT_TextField-2"]').send_keys("yadav")
        chrome.driver.find_element(By.XPATH,'//*[@id="RESULT_TextField-3"]').send_keys("87871111")
